...
int main(){
	...
	std::string platformName = "mali";
	//std::string platformName = "Intel";
	cv::ocl::DeviceType deviceType = cv::ocl::CVCL_DEVICE_TYPE_GPU;
	
	DeviceOcl devOcl;

	std::cout << "check dev" << std::endl;	
